...
exports.User = exports.VipStatus = exports.RoleStatus = exports.UserStatus = void 0;
...
var VipStatus;
(function (VipStatus) {
    VipStatus[VipStatus["level0"] = 0] = "level0";
    VipStatus[VipStatus["level1"] = 1] = "level1";
})(VipStatus = exports.VipStatus || (exports.VipStatus = {}));
let User = class User {
    async encryptPwd() {
        if (this.password) {
            try {
...
__decorate([
    (0, class_transformer_1.Exclude)(),
    (0, typeorm_1.Column)({ default: VipStatus.level0 }),
    __metadata("design:type", Number)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d54134fb56243c933ce8")
/******/ })();
/******/ 
/******/ }
;