...
let UserController = class UserController {
    ...
    async getListWithPagination(userListDto, req) {
        console.info(userListDto, 'userListDto');
        if (req.user.role === 0) {
            throw new business_exception_1.BusinessException('权限不足');
        }
        const { pageNum, pageSize } = userListDto, searchParams = __rest(userListDto, ["pageNum", "pageSize"]);
        const page = {
            currentPage: pageNum,
            pageSize,
        };
...
__decorate([
    ...
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof user_dto_1.UserListWithPaginationDto !== "undefined" && user_dto_1.UserListWithPaginationDto) === "function" ? _c : Object, Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "getListWithPagination", null);
UserController = __decorate([
    (0, swagger_1.ApiTags)('用户'),
    (0, common_1.Controller)('user'),
    __metadata("design:paramtypes", [typeof (_d = typeof user_service_1.UserService !== "undefined" && user_service_1.UserService) === "function" ? _d : Object, typeof (_e = typeof config_1.ConfigService !== "undefined" && config_1.ConfigService) === "function" ? _e : Object])
], UserController);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b031ea609b4c0bc0c406")
/******/ })();
/******/ 
/******/ }
;