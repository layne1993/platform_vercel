...
const Step7 = (props) => {
    ...
    const examine = (type) => {
        ...
        const {getInfo} = props;
        dispatch({
            type: 'signprocess/SaveSecondReviewCheck',
            payload: { signFlowId: infomation.signFlowId,
                secondReviewFeedback,
                secondReviewCheckType: type,
                codeValueList: values.codeValueList
            },
            callback: (res) => {
...
export default connect(({ signprocess, loading }) => ({
    ...
    submitting: loading.effects['signprocess/SaveSecondReviewCheck']
}))(Step7);
