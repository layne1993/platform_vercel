...
class AssetAllocation extends Component {
    ...
    Insert = ()=>{
        this.props.showInsert('资产配置情况');
      }
  
      confirm =(e)=> {
  
          this.props.delete('YWFX_0008')
      }
    ...
    render() {
        ...
        return (
               <Card
                    bordered={false}
                    title={
                        <span className={styles.cardTitle}>资产配置情况（敬请期待）</span>
                    }
                    extra={<div>
                    ...
                    style={{height:'458px',verticalAlign:'top',  marginBottom:10,width:'47%',display:'inline-block',margin:'1%',}}
                >
