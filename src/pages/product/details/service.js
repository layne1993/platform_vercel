...
export async function getFundInfo(params) {
    return axios.postJSON('/product/getFundInfo', params);
}
...
// 根据产品名称或者产品编号获取基金信息
export async function getAMACFundInfo(params) {
    return axios.postJSON('/product/getAMACFundInfo', params);
}

// 获取产品详情红点
export async function getProductNoticeStatistics(params) {
    return axios.get('/product/getProductNoticeStatistics', params);
}
