...
var CoreRender = function CoreRender(_ref2) {
  var id = _ref2.id,
      ...
      rest = _objectWithoutProperties(_ref2, ["id", "item", "dataIndex", "dataPath", "hideTitle", "hideValidation", "debugCss", "schema", "_value", "dependValues", "displayType", "column", "labelWidth", "readOnly", "errorFields", "effectiveLabelWidth"]);
