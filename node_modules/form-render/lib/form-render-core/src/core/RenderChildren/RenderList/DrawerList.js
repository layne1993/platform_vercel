...
var DrawerList = function DrawerList(_ref) {
  ...
  var buttons = itemProps.buttons,
      columnProps = _objectWithoutProperties(itemProps, ["buttons"]);

  var _props$pagination = props.pagination,
      pagination = _props$pagination === void 0 ? {} : _props$pagination,
      rest = _objectWithoutProperties(props, ["pagination"]);
  ...
  var columns = children.map(function (child) {
    ...
    return _objectSpread({
      ...
      render: function render(value, record) {
        ...
        return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", null, (0, _utils.getDisplayValue)(value, schema)), errorObj.error && /*#__PURE__*/_react.default.createElement(_ErrorMessage.default, {
