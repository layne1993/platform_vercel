...
var copyItem = function copyItem(flatten, $id) {
  ...
  try {
    var item = flatten[$id];
    var newId = "".concat($id, "_").concat(nanoid(6));
...
var Element = function Element(_ref) {
  ...
  var _useDrag = useDrag({
    ...
    item: {
      ...
      $id: fixedName ? "#/".concat(name) : "#/".concat(name, "_").concat(nanoid(6))
    },
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: dragRef
  }, /*#__PURE__*/React.createElement(WidgetUI, {
    text: text,
    icon: icon,
...
var RenderField = function RenderField(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, schema.title ? /*#__PURE__*/React.createElement("div", {
