...
var copyItem = function copyItem(flatten, $id) {
  var newFlatten = _objectSpread2({}, flatten);

  try {
    var item = flatten[$id];
    var newId = "".concat($id, "_").concat(nanoid.nanoid(6));
...
var addItem = function addItem(_ref5) {
  ...
  if (_selected && _selected[0] === '0' || _selected === '#') {
    ...
    try {
      ...
      newId = _selected === '#' ? "#/".concat(name) : "".concat(oldId, "/").concat(name);

      if (!fixedName) {
        newId += "_".concat(nanoid.nanoid(6));
      }
  ...
  if (!fixedName) {
    _name += "_".concat(nanoid.nanoid(6));
  }
...
var dynamicCSS_2 = dynamicCSS.updateCSS;
...
function Provider(props, ref) {
  ...
  var _useState = React.useState([]),
      ...
      itemError = _useState2[0],
      setItemError = _useState2[1]; // 收口点 propsSchema 到 schema 的转换 (一共3处，其他两个是 importSchema 和 setValue，在 FRWrapper 文件)
...
var Element = function Element(_ref) {
  ...
  var _useDrag = reactDnd.useDrag({
    ...
    item: {
      ...
      $id: fixedName ? "#/".concat(name) : "#/".concat(name, "_").concat(nanoid.nanoid(6))
    },
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!(itemError === null || itemError === void 0 ? void 0 : itemError.length)) {
                _context.next = 2;
                break;
              }
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ref: dragRef
  }, /*#__PURE__*/React__default['default'].createElement(WidgetUI, {
    text: text,
    icon: icon,
...
var Sidebar = function Sidebar(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      className: "pl0"
    }, Array.isArray(item.widgets) ? item.widgets.map(function (widget, idx) {
...
var RenderField = function RenderField(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, schema.title ? /*#__PURE__*/React__default['default'].createElement("div", {
...
function Wrapper(_ref) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(didDrop || (itemError === null || itemError === void 0 ? void 0 : itemError.length))) {
                  _context.next = 3;
                  break;
                }
  ...
  var deleteItem = function deleteItem(e) {
    ...
    var newSelect = '#'; // 计算删除后新被选中的元素：
    // 1. 如果是第一个，选第二个
    // 2. 如果不是第一，选它前一个
    // 3. 如果同级元素没了，选parent

    try {
      var parent = newFlatten[$id].parent;
      var siblings = newFlatten[parent].children;
    ...
    var _canDelete = typeof canDelete === 'function' ? canDelete(newFlatten[$id].schema) : canDelete;
  ...
  var handleItemCopy = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var _copyItem, _copyItem2, newFlatten, newId;
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              _copyItem = copyItem(flatten, $id), _copyItem2 = _slicedToArray(_copyItem, 2), newFlatten = _copyItem2[0], newId = _copyItem2[1];
              onFlattenChange(newFlatten);
              setGlobal({
                selected: newId
              });
    ...
    return function handleItemCopy(_x4) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: "field-wrapper ".concat(isSelected ? 'selected-field-wrapper' : '', " relative w-100"),
    onClick: handleClick
...
var FR = function FR(_ref2) {
  ...
  var isList = schema.type === 'array' && schema.enum === undefined;
...
function ItemSettings(_ref) {
  ...
  var _widgets = _objectSpread2(_objectSpread2({}, globalWidgets), {}, {
    idInput: IdInput,
    ...
    return settings.reduce(function (widgetList, setting) {
      ...
      var basicWidgets = setting.widgets.map(function (item) {
        ...
        return _objectSpread2(_objectSpread2({}, item), {}, {
          ...
          setting: _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, baseCommonSettings), commonSettings), baseItemSettings), item.setting)
        });
      });
  ...
  React.useEffect(function () {
    onItemErrorChange(form === null || form === void 0 ? void 0 : form.errorFields);
  }, [form === null || form === void 0 ? void 0 : form.errorFields]);
  return /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
      paddingRight: 24
    }
